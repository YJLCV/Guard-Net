...
parser.add_argument('--datapath', default="/srv/yjl_data/dataset/SceneFlow/", help='data path')
...
parser.add_argument('--lrepochs',default="22,52,62,72,92,102,112:2", type=str,  help='the epochs to decay lr: the downscale rate')
...
def train():
    ...
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        if (epoch_idx + 1) % args.save_freq == 0:
            ...
            torch.save(checkpoint_data, "{}/transformer_sceneflow_{}_epoch.ckpt".format(args.logdir, epoch_idx))
        gc.collect()
